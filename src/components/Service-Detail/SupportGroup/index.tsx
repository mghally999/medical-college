...
const SupportGroup: FC = () => {
    return (
        <>
            <section>
                <div className="py-9" data-aos="fade-up" data-aos-duration="1000">
                    <h2 className="text-[35px] leading-[2.87rem] font-bold text-midnight_text dark:text-white ">Support Groups for Depression</h2>
                    ...
                    <p className="text-base font-normal text-black text-opacity-50 dark:text-white dark:text-opacity-50 mb-6">
