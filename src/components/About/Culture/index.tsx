    ...
    <section className="dark:bg-darkmode">
      <div className="container mx-auto lg:max-w-screen-xl max-w-screen-md">
        <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-7">
          <div
            className="lg:col-span-6 col-span-12 relative rounded-lg"
            data-aos="fade-right"
            data-aos-delay="200"
          ...
          >
            ...
            <div className="absolute top-12 rounded-lg -right-14 bg-primary gap-5 py-6 px-8 sm:w-auto w-full">
              <h2 className="text-white font-bold text-[97px] leading-[7.93rem]">
                13<span className="text-[45px] leading-[1.2]">+</span>
              </h2>
          ...
          <div
            className="lg:col-span-5 col-span-12 lg:pl-8 pl-0"
            data-aos="fade-left"
            data-aos-delay="200"
            data-aos-duration="1000"
          >
