...
const ContactInfo = () => {
  return (
    <>
      <section className="dark:bg-darkmode pt-8 lg:pb-24 pb-16">
        <div className="container mx-auto max-w-screen-xl">
          <div className="flex md:flex-row flex-col items-stretch justify-center sm:gap-28 gap-8">
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div>
                ...
                <p className="text-black text-opacity-50 font-normal text-xl max-w-80 pt-3 pb-7 dark:text-white dark:text-opacity-50">
                  Please feel free to drop us a line. We will respond as soon as
                  possible.
                </p>
                <div>
                  <Link href="#" className="text-primary text-lg font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    Leave a message
                    <svg
                      width="23"
                      height="17"
          ...
          <div className="md:pt-32 pt-11 md:pb-28 pb-16">
