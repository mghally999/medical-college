...
const ContactForm = () => {
  ...
  return (
    <>
      <section className="dark:bg-darkmode lg:pb-24 pb-16">
        <div className="container mx-auto max-w-screen-xl">
          <div className="grid md:grid-cols-12 grid-cols-1 gap-8">
            <div className="col-span-6 md:pt-12 pt-0">
              <h2 className="max-w-72 text-[40px] leading-[3rem] font-bold mb-9">Get Online Consultation</h2>
              <form className="flex flex-wrap w-full m-auto justify-between">
                ...
                <div className="sm:flex gap-3 w-full">
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    ...
                    <select id='Specialist' className="w-full text-base px-4 py-2.5 rounded-lg border-border dark:text-white border-solid dark:bg-darkmode border transition-all duration-500 focus:border-primary dark:focus:border-primary dark:border-dark_border focus:border-solid focus:outline-0">
                ...
                <div className="sm:flex gap-3  w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    ...
                    <input
                      id='date'
                      className="w-full text-base px-4 rounded-lg  py-2.5 outline-none dark:text-white dark:bg-darkmode border-border border-solid border transition-all duration-500 focus:border-primary dark:focus:border-primary dark:border-dark_border focus:border-solid focus:outline-0"
                      type="date"
                    />
                  </div>
                  <div className="mx-0 my-2.5 flex-1">
                ...
                <div className="mx-0 my-2.5 w-full">
                  <Link href="#" className="bg-primary rounded-lg text-white py-4 px-8 mt-4 inline-block hover:bg-blue-700" type="submit">
                    Make an appointment
                  </Link>
                </div>
              </form>
