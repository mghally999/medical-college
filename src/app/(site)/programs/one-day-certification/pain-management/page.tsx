...
const PainManagementCourse = () => {
  ...
  const overviewPoints = [
    "Comprehensive Curriculum: Covers pain assessment, pain management strategies, and evidence-based practices.",
    "Hands-On Learning: Learn practical techniques and strategies for managing pain in real-world clinical settings.",
    "Expert Instructors: Delivered by experienced pain management specialists with extensive clinical experience.",
    "Internationally Recognized Certification: Certification is valid for 2 years and accepted globally.",
    "Interactive Format: Includes lectures, discussions, and practical activities to ensure learning and skills development.",
  ];

  const entryRequirements = [
    "Minimum Age: 18 years or older.",
    "Educational Background: Healthcare professionals or students in a medical field.",
  ...
  const courseOutline = [
    {
      ...
      points: [
        "Overview of pain physiology and the types of pain.",
        "Understanding the impact of pain on patients and healthcare systems.",
      ],
    },
    {
      title: "Pain Assessment Techniques",
      points: [
        "Learning to assess and quantify pain using standard tools and scales (e.g., visual analog scale, numeric pain rating scale).",
        "Tailoring assessment methods for acute and chronic pain in different populations (adults, elderly, pediatrics).",
      ],
    },
    {
      title: "Pharmacological Pain Management",
      points: [
        "Overview of pharmacological interventions for pain, including opioids, non-opioids, adjuvants, and their appropriate use.",
        "Strategies for managing opioid use and addressing opioid-related side effects and risks.",
      ],
    },
    {
      title: "Non-Pharmacological Pain Management",
      points: [
        "Cognitive-behavioral therapy (CBT), mindfulness, relaxation techniques, and physical therapies.",
        "The role of acupuncture, TENS (Transcutaneous Electrical Nerve Stimulation), and other alternative therapies.",
      ],
    },
    {
      title: "Multidisciplinary Approach to Pain Management",
      points: [
        "Collaborating with other healthcare providers to create comprehensive pain management plans.",
        "Case studies and role-playing to develop multidisciplinary management plans.",
      ],
    },
    {
      title: "Pain Management in Special Populations",
      points: [
        "Pain management in specific groups, including pediatric, geriatric, and palliative care patients.",
        "Managing pain in patients with comorbid conditions (e.g., cancer, diabetes, and fibromyalgia).",
      ],
    },
    {
      title: "Legal and Ethical Considerations",
      points: [
        "Understanding the ethical principles of pain management, including patient autonomy and informed consent.",
        "Navigating the legal aspects of prescribing controlled substances.",
      ],
    },
  ];

  const courseObjectives = [
    "Effectively assess and quantify pain in various patient populations.",
    "Understand the pharmacological and non-pharmacological strategies for pain management.",
    "Design and implement individualized pain management plans.",
    "Recognize and address the ethical and legal considerations in pain management.",
    "Incorporate a multidisciplinary approach to the management of acute and chronic pain.",
  ];

  const assessmentPoints = [
    "Participants will be assessed through a combination of case studies, discussions, and quizzes.",
    "On successful completion, participants will receive a Pain Management Certificate, valid for 2 years.",
    "Healthcare professionals may receive CME points depending on the accrediting body.",
  ];

  const careerOpportunities = [
    "Doctors, Nurses, and Pharmacists",
    "Physical Therapists and Occupational Therapists",
    "Palliative Care Providers and Hospice Care Workers",
    "Pain Management Specialists and Healthcare Consultants",
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-20 text-center bg-gradient-to-br from-[#1a1f3a] via-[#0a0f2c] to-[#4B0E1E] overflow-hidden">
        ...
        >
          ...
          >
            Enhance your knowledge and skills in managing acute and chronic pain
            with evidence-based strategies and interventions.
          </motion.p>
      ...
      <SectionWrapper color="blue">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            subtitle="The 1-Day Pain Management Course is designed for healthcare professionals seeking to enhance their knowledge and skills in the management of acute and chronic pain."
            delay={0.2}
            color="blue"
          />
      ...
      <SectionWrapper color="red">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedTitle
            title="Master Pain Management Techniques"
            subtitle="Enhance your skills in managing acute and chronic pain with evidence-based strategies"
            delay={0.2}
            color="red"
          />
...
export default PainManagementCourse;
