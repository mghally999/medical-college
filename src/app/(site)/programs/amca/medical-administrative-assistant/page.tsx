...
const MedicalAdministrativeAssistantCourse = () => {
  ...
  const qualificationUnits = [
    {
      ...
      description:
        "Learn the standards for patient privacy and confidentiality, as well as the legal requirements for maintaining HIPAA compliance in healthcare settings.",
      percentage: "19%",
    },
    {
      title: "Scheduling",
      description:
        "Master the techniques for managing patient appointments, coordinating schedules, and ensuring efficient use of healthcare providers' time.",
      percentage: "13%",
    },
    {
      title: "Medical Records",
      description:
        "Study the management of patient records, including electronic health records (EHR), filing systems, and legal requirements for documentation.",
      percentage: "11%",
    },
    {
      title: "Other Administrative Knowledge",
      description:
        "Gain knowledge in the essential administrative tasks needed to run a medical office, including communication, office management, and supporting healthcare providers.",
      percentage: "9%",
    },
    {
      title: "Insurance",
      description:
        "Understand the various types of health insurance, including private, government, and managed care plans, and how to manage insurance information.",
      percentage: "15%",
    },
    {
      title: "Medical Billing and Coding",
      description:
        "Learn the basics of medical billing and coding, including the use of ICD-10, CPT, and HCPCS codes for claims processing and reimbursement.",
      percentage: "11%",
    },
    {
      title: "Medical Terminology and Anatomy",
      description:
        "Familiarize yourself with medical terminology, abbreviations, and human anatomy to effectively assist in clinical settings and ensure accurate medical documentation.",
      percentage: "13%",
    },
    {
      title: "Emergency Care",
      description:
        "Understand the basic protocols for handling medical emergencies, including first aid, CPR, and emergency medical procedures.",
      percentage: "9%",
    },
  ];

  const examInfo = [
    { label: "Abbreviation", value: "MAAC" },
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-20 text-center bg-gradient-to-br from-[#1a1f3a] via-[#0a0f2c] to-[#4B0E1E] overflow-hidden">
        ...
        >
          ...
          >
            Equip yourself with essential skills and knowledge to succeed in
            medical administrative roles in various healthcare settings.
          </motion.p>
      ...
      <SectionWrapper color="blue">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            subtitle="The AMCA Medical Administrative Assistant Certification program is designed to provide individuals with the essential skills and knowledge required to succeed in medical administrative roles."
            delay={0.2}
            color="blue"
          />
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed text-center mb-14">
            <p>
              This comprehensive program covers areas such as HIPAA compliance,
              medical records management, patient scheduling, billing, coding,
              and insurance. By the end of the course, participants will be
              equipped to handle the administrative tasks of medical offices,
              clinics, hospitals, and healthcare providers efficiently.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              "Comprehensive curriculum covering all essential medical administrative skills",
              "Focus on HIPAA compliance and medical records management",
              "Industry-recognized certification",
              "Experienced instructors with healthcare expertise",
              "Preparation for various medical administrative roles",
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="The program consists of several core units that ensure participants develop both the technical and administrative skills needed in the healthcare environment."
          />
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <AnimatedCard index={1} className="md:col-span-2" color="blue">
            ...
            <div className="text-lg leading-relaxed text-center">
              <p className="mb-4">
                Participants will be assessed through a combination of practical
                assessments, case studies, and written exams. Upon successful
                completion of the course, participants will receive an AMCA
                Medical Administrative Assistant Certificate.
              </p>
              <p>
                The certification demonstrates your competency in medical
                administrative techniques and enhances your employability in
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="Graduates of the AMCA Medical Administrative Assistant Certification program are prepared to work in various healthcare settings, including hospitals, outpatient clinics, private practices, and more."
          />
      ...
      <SectionWrapper color="blue">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedTitle
            title="Start Your Medical Administrative Career Today"
            subtitle="Join our certification program to gain the skills needed for a rewarding career in healthcare administration"
            delay={0.2}
            color="blue"
          />
...
export default MedicalAdministrativeAssistantCourse;
