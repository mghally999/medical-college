...
const PhlebotomyTechnicianCourse = () => {
  ...
  const qualificationUnits = [
    {
      title: "Professionalism and Regulatory Compliance",
      description:
        "Understand the importance of professionalism in phlebotomy, including adherence to regulatory standards and ethics in healthcare practices.",
      percentage: "18%",
    },
    {
      title: "Infection Control and Safety",
      description:
        "Learn protocols for preventing infection, proper handling of sharps, and maintaining a safe environment for both patients and healthcare workers.",
      percentage: "16%",
    },
    {
      title: "Patient Identification, Assessment, and Site Preparation",
      description:
        "Master techniques for correctly identifying patients, assessing their needs, and preparing the site for blood collection to ensure successful and safe procedures.",
      percentage: "17%",
    },
    {
      title: "Equipment Selection and Maintenance",
      description:
        "Gain knowledge on selecting the right equipment for various phlebotomy procedures and maintaining it for optimal performance and hygiene.",
      percentage: "10%",
    },
    {
      title: "Collection of Blood and Non-Blood Specimens",
      description:
        "Learn the techniques for collecting blood samples, as well as non-blood specimens like urine and stool, in a controlled, hygienic, and effective manner.",
      percentage: "29%",
    },
    {
      title: "Specimen Processing and Transportation",
      description:
        "Understand how to properly process and transport specimens to ensure their integrity for diagnostic testing.",
      percentage: "10%",
    },
  ];

  const examInfo = [
    { label: "Abbreviation", value: "PTC" },
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-20 text-center bg-gradient-to-br from-[#1a1f3a] via-[#0a0f2c] to-[#4B0E1E] overflow-hidden">
        ...
        >
          ...
          >
            Designed to provide participants with the skills and knowledge
            necessary to perform phlebotomy procedures competently in various
            healthcare settings.
          </motion.p>
      ...
      <SectionWrapper color="blue">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            subtitle="The AMCA Phlebotomy Technician Certificate program provides comprehensive training in blood collection techniques and specimen handling."
            delay={0.2}
            color="blue"
          />
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed text-center mb-14">
            <p>
              This comprehensive program covers essential topics including
              patient identification, blood collection techniques, infection
              control, and specimen processing. By the end of the course,
              participants will be prepared to work as certified phlebotomy
              technicians in hospitals, clinics, and diagnostic laboratories.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              "Comprehensive curriculum covering phlebotomy procedures",
              "Focus on patient safety and infection control",
              "Industry-recognized certification",
              "Experienced instructors with healthcare expertise",
              "Preparation for various phlebotomy roles",
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="The program includes core units that provide both theoretical and practical knowledge necessary for working as a phlebotomy technician."
          />
          ...
          <AnimatedCard index={1} className="md:col-span-2" color="blue">
            ...
            <div className="text-lg leading-relaxed text-center">
              <p className="mb-4">
                ...
                the course, participants will receive an AMCA Phlebotomy
                Technician Certificate.
              </p>
              <p>
                The certification demonstrates your competency in phlebotomy
                procedures and enhances your employability in various healthcare
                settings.
              </p>
            </div>
          </AnimatedCard>
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="Graduates of the AMCA Phlebotomy Technician Certificate program are equipped to work in a variety of healthcare settings."
          />
      ...
      <SectionWrapper color="blue">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedTitle
            title="Start Your Phlebotomy Career Today"
...
export default PhlebotomyTechnicianCourse;
