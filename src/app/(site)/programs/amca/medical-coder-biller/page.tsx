...
const MedicalCoderBillerCourse = () => {
  ...
  const qualificationUnits = [
    {
      ...
      description:
        "Learn the key terms, abbreviations, and concepts used in medical coding, with a focus on human anatomy and how it relates to medical procedures and diagnoses.",
      percentage: "11%",
    },
    {
      title: "CPT/HCPCS",
      description:
        "Gain expertise in the Current Procedural Terminology (CPT) and Healthcare Common Procedure Coding System (HCPCS) for accurate medical billing and coding.",
      percentage: "17%",
    },
    {
      title: "ICD-10",
      description:
        "Study the ICD-10 coding system, which is essential for classifying diagnoses and procedures for billing and reimbursement purposes.",
      percentage: "16%",
    },
    {
      title: "Types of Insurance",
      description:
        "Understand the various types of insurance, such as private, public, and government programs, and their implications for medical coding and billing.",
      percentage: "8%",
    },
    {
      title: "Billing Regulations",
      description:
        "Learn about the rules and regulations governing the practice of medical billing to ensure compliance with legal and industry standards.",
      percentage: "11%",
    },
    {
      title: "Reimbursement and Collections",
      description:
        "Master the processes for insurance reimbursement and the best practices for managing collections from patients and insurance companies.",
      percentage: "12%",
    },
    {
      title: "Billing",
      description:
        "Learn how to generate and process medical bills accurately for healthcare services rendered, ensuring compliance with industry standards.",
      percentage: "16%",
    },
    {
      title: "Regulations and Guidelines",
      description:
        "Study the guidelines and regulations that medical coders and billers must follow to ensure ethical practices and proper coding in healthcare settings.",
      percentage: "10%",
    },
  ];

  const examInfo = [
    { label: "Abbreviation", value: "MCBC" },
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-20 text-center bg-gradient-to-br from-[#1a1f3a] via-[#0a0f2c] to-[#4B0E1E] overflow-hidden">
        ...
        >
          ...
          >
            Equip yourself with the essential knowledge and skills required to
            excel in medical coding and billing in various healthcare settings.
          </motion.p>
      ...
      <SectionWrapper color="blue">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            subtitle="The AMCA Medical Coder and Biller Certification program is designed to equip individuals with the essential knowledge and skills required to excel in medical coding and billing."
            delay={0.2}
            color="blue"
          />
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed text-center mb-14">
            <p>
              This comprehensive program covers critical areas such as medical
              terminology, insurance types, billing regulations, and
              reimbursement processes. By the end of the course, participants
              will be proficient in using the CPT, ICD-10, and HCPCS coding
              systems, and will be prepared for certification and employment as
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              "Comprehensive curriculum covering all medical coding and billing essentials",
              "Focus on CPT, ICD-10, and HCPCS coding systems",
              "Industry-recognized certification",
              "Experienced instructors with healthcare expertise",
              "Preparation for various medical coding and billing roles",
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="The program consists of several core units designed to provide a well-rounded education in medical coding and billing."
          />
          ...
          <AnimatedCard index={1} className="md:col-span-2" color="blue">
            ...
            <div className="text-lg leading-relaxed text-center">
              <p className="mb-4">
                ...
                Medical Coder and Biller Certificate.
              </p>
              <p>
                The certification demonstrates your competency in medical coding
                and billing techniques and enhances your employability in
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="Graduates of the AMCA Medical Coder and Biller Certification program are prepared for a wide range of career opportunities in the healthcare industry."
          />
...
export default MedicalCoderBillerCourse;
