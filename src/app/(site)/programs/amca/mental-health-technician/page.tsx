...
const MentalHealthTechnicianCourse = () => {
  ...
  const qualificationUnits = [
    {
      ...
      description:
        "Learn essential protocols for assessing patients, creating treatment plans, and monitoring progress in mental health care settings.",
      percentage: "9%",
    },
    {
      title: "Psychological Development",
      description:
        "Study mental health disorders and therapeutic approaches across the lifespan, focusing on diagnosis and treatment.",
      percentage: "57%",
    },
    {
      title: "Pharmacology",
      description:
        "Understand medications used in mental health treatment, including their administration, side effects, and monitoring.",
      percentage: "19%",
    },
    {
      title: "Medical Office/Patient Care Skills",
      description:
        "Gain skills in patient interaction, documentation, and maintaining confidentiality in healthcare settings.",
      percentage: "12%",
    },
    {
      title: "Practice Settings",
      description:
        "Explore various healthcare environments where mental health technicians work, focusing on patient care and safety.",
      percentage: "3%",
    },
  ];

  const examInfo = [
    { label: "Abbreviation", value: "MHTC" },
    { label: "Total Number of Questions on Exam", value: "75" },
  ...
  const careerOpportunities = [
    ...
    "Healthcare Assistant in Mental Health Settings",
  ];
    ...
    >
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 px-6 md:px-20 text-center bg-gradient-to-br from-[#1a1f3a] via-[#0a0f2c] to-[#4B0E1E] overflow-hidden">
        ...
        >
          ...
          >
            Designed to equip healthcare professionals with the necessary skills
            to provide effective care and support to individuals with mental
            health conditions.
          </motion.p>
      ...
      <SectionWrapper color="blue">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            subtitle="The AMCA Mental Health Technician Certificate is designed to equip healthcare professionals with the necessary skills to provide effective care and support to individuals with mental health conditions."
            delay={0.2}
            color="blue"
          />
          ...
          <div className="max-w-4xl mx-auto text-lg leading-relaxed text-center mb-14">
            <p>
              This comprehensive program covers essential areas such as
              psychological development, pharmacology, medical office skills,
              and infection control within mental health settings. The
              certification is ideal for individuals who aspire to work as
              mental health technicians in hospitals, clinics, rehabilitation
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              "Comprehensive curriculum covering mental health care essentials",
              "Focus on psychological development and therapeutic approaches",
              "Understanding of pharmacology in mental health treatment",
              "Development of patient care and medical office skills",
              "Industry-recognized certification",
              "Preparation for various mental health technician roles",
            ].map((point, index) => (
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="The program includes core units that provide both theoretical and practical knowledge necessary for working in mental health care settings."
          />
          ...
          <AnimatedCard index={1} className="md:col-span-2" color="blue">
            ...
            <div className="text-lg leading-relaxed text-center">
              <p className="mb-4">
                ...
                the course, participants will receive an AMCA Mental Health
                Technician Certificate.
              </p>
              <p>
                The certification demonstrates your competency in mental health
                care and enhances your employability in various healthcare
                settings.
              </p>
            </div>
          </AnimatedCard>
      ...
      <SectionWrapper color="red">
        <div className="max-w-6xl mx-auto relative z-10">
          <AnimatedTitle
            ...
            delay={0.2}
            color="red"
            subtitle="Graduates of the AMCA Mental Health Technician Certificate program are equipped to work in a variety of healthcare settings."
          />
      ...
      <SectionWrapper color="blue">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <AnimatedTitle
            title="Start Your Mental Health Career Today"
            subtitle="Join our certification program to gain the skills needed for a rewarding career in mental healthcare"
            delay={0.2}
            color="blue"
          />
...
export default MentalHealthTechnicianCourse;
